    ...
    render() {
        ...
        <nav class="col-span-7 py-2  mx-auto">
            <ul >
                ...
                <li class="inline-block pr-4 text-white "><a href="/tintuc">Admin</a></li>
            </ul>
        </nav>
        <div class="search col-span-5 py-2 pl-8">
            ...
            <button class="border border-black bg-black text-white p-1" type="submit"><a href="/SignIn">Sign-in</a></button>
            <button class="border border-black bg-black text-white p-1" type="submit"><a href="/SignUp">Sign-up</a></button>
        </div>
        </div>
        <div class="pt-1.5">
